...
<style>
  ...
  .chart-peak {
    ...
    height: 58px;
    border-radius: 50%;
    background: radial-gradient(circle at 30% 30%, rgba(37, 99, 235, 0.45), transparent 70%);
  ...
  .chart-peak--secondary {
    left: 62%;
    transform: rotate(-8deg);
    background: radial-gradient(circle at 30% 30%, rgba(14, 165, 233, 0.4), transparent 70%);
  }
